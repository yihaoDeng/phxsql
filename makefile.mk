...
ROCKSDB_INCLUDE_PATH=$(SRC_BASE_PATH)/third_party/rocksdb/include
...
ROCKSDB_LIB_PATH=$(SRC_BASE_PATH)/third_party/rocksdb
...
CXX=g++
CXXFLAGS+=-std=c++11
CPPFLAGS+=-I$(SRC_BASE_PATH) -I$(PROTOBUF_INCLUDE_PATH)  -I$(ROCKSDB_INCLUDE_PATH)
CPPFLAGS+=-I$(GFLAGS_INCLUDE_PATH) -I$(GLOG_INCLUDE_PATH)
CPPFLAGS+=-Wall -g -fPIC -m64

LDFLAGS += -L$(PHXPAXOS_LIB_PATH) -L$(PHXSQL_LIB_PATH) -L$(PROTOBUF_LIB_PATH) -L$(ROCKSDB_LIB_PATH)
